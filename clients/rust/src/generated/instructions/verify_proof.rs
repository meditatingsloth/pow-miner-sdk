...
impl VerifyProof {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&VerifyProofInstructionData::new()).unwrap();
...
pub struct VerifyProofInstructionData {
    discriminator: [u8; 8],
}

impl VerifyProofInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for VerifyProofInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct VerifyProofInstructionArgs {
    pub slot: u64,
    pub nonce: u64,
    pub hash: [u8; 32],
...
/// Instruction builder for `VerifyProof`.
///
/// ### Accounts:
///
...
impl VerifyProofBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = VerifyProofInstructionArgs {
...
/// `verify_proof` CPI accounts.
pub struct VerifyProofCpiAccounts<'a, 'b> {
...
/// `verify_proof` CPI instruction.
pub struct VerifyProofCpi<'a, 'b> {
    ...
    pub __args: VerifyProofInstructionArgs,
}

impl<'a, 'b> VerifyProofCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: VerifyProofCpiAccounts<'a, 'b>,
        args: VerifyProofInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `VerifyProof` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` user
...
///   5. `[]` system_program
#[derive(Clone, Debug)]
pub struct VerifyProofCpiBuilder<'a, 'b> {
    instruction: Box<VerifyProofCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> VerifyProofCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(VerifyProofCpiBuilderInstruction {
            __program: program,
            user: None,
            user_account: None,
            proof: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = VerifyProofCpi {
...
#[derive(Clone, Debug)]
struct VerifyProofCpiBuilderInstruction<'a, 'b> {

...
impl TopUpEscrow {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&TopUpEscrowInstructionData::new()).unwrap();
...
pub struct TopUpEscrowInstructionData {
    discriminator: [u8; 8],
}

impl TopUpEscrowInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [48, 220, 80, 92, 122, 91, 195, 169],
        }
    }
}

impl Default for TopUpEscrowInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct TopUpEscrowInstructionArgs {
    pub amount: u64,
}

/// Instruction builder for `TopUpEscrow`.
///
/// ### Accounts:
///
///   0. `[writable]` user
...
impl TopUpEscrowBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = TopUpEscrowInstructionArgs {
...
/// `top_up_escrow` CPI accounts.
pub struct TopUpEscrowCpiAccounts<'a, 'b> {
...
/// `top_up_escrow` CPI instruction.
pub struct TopUpEscrowCpi<'a, 'b> {
    ...
    pub __args: TopUpEscrowInstructionArgs,
}

impl<'a, 'b> TopUpEscrowCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: TopUpEscrowCpiAccounts<'a, 'b>,
        args: TopUpEscrowInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `TopUpEscrow` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` user
...
///   5. `[]` system_program
#[derive(Clone, Debug)]
pub struct TopUpEscrowCpiBuilder<'a, 'b> {
    instruction: Box<TopUpEscrowCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> TopUpEscrowCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(TopUpEscrowCpiBuilderInstruction {
            __program: program,
            user: None,
            escrow: None,
            master: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = TopUpEscrowCpi {
...
#[derive(Clone, Debug)]
struct TopUpEscrowCpiBuilderInstruction<'a, 'b> {
